...
predicted_probabilities = machine.predict_proba(new_reviews_tranformed)

# Threshold for considering as "really bad"
threshold = 0.33  # Adjust this threshold as needed

# Classify as "really bad" (1) if probability of class 1 is greater than threshold
predicted_classes = ['really bad' if prob[0] > threshold else 'not really bad' for prob in predicted_probabilities]
...
new_reviews['Predicted_Stars'] = predicted_classes
...
new_reviews['predicted_classes'] = predicted_classes
